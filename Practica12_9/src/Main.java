...
public class Main {
    public static void main(String[] args){
        AdministraciónCuentas1 cuenta = new AdministraciónCuentas1("4834181809", "Joshua Moises Cervantes Arredondo", 22, 1000.00);
        ...
        do {
            ...
            switch (Opción){
                ...
                case 2:
                    ...
                    AdministraciónCuentas1.ingresarEfectivo(ingreso);
                    JOptionPane.showMessageDialog(null, "Ingreso exitoso , su nuevo saldo es de: " + AdministraciónCuentas1.getSaldo());
                    break;

                case 3:
                    double retiro = Double.parseDouble(JOptionPane.showInputDialog("¿Cuanto desea Retirar: $"));
                    if (cuenta.retirarEfectivo(retiro));
                    JOptionPane.showMessageDialog(null, "Retiro exitoso, su nuevo saldo es de: " + AdministraciónCuentas1.getSaldo());
                    break;
                ...
                case 4:
                    ...
                    JOptionPane.showMessageDialog(null, "Deposito exitoso, su nuevo saldo es de: " + AdministraciónCuentas1.getSaldo());
                    break;
